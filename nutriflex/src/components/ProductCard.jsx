    ...
    >
      ...
      <div className="relative bg-white p-2" > 
        ...
        <img
          ...
          alt={product.name}
          className="w-full rounded-lg object-contain h-44 sm:h-40"
          loading="lazy"
        />
        {product.featured && (
      ...
      <div className="mt-3">
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <button
            className="w-full inline-flex items-stretch rounded-md bg-[#00d000] hover:bg-[#00b800] text-white text-sm"
            onClick={(e) => { e.stopPropagation(); onQuickBuy(product); navigate('/checkout'); }}
          >
